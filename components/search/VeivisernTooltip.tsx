...
export default function VeivisernTooltip({ novaClass }: VeivisernTooltipProps) {
    ...
    if (novaClass === NovaClass.THREE) {
        ...
        detailText = "Denne ingrediensen faller under kategori 3 av Nova-klassifiseringen"
    } else { // (novaClass === NovaClass.FOUR)
        titleText = "Ultraprosessert ingrediens"
        detailText = "Denne ingrediensen faller under kategori 4 av Nova-klassifiseringen"
    }
